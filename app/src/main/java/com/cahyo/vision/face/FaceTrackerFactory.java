...
import com.cahyo.vision.face.ui.camera.GraphicOverlay;
...
//        canvas.drawText("id: " + getId(), cx + ID_X_OFFSET, cy + ID_Y_OFFSET, mIdPaint);
        ...
        canvas.drawText("Mouth: " + String.format(Locale.ENGLISH, "%.2f", face.getIsSmilingProbability()),
                cx + ID_X_OFFSET, cy + ID_Y_OFFSET * 4, mIdPaint);
        canvas.drawText("right: " + String.format(Locale.ENGLISH, "%.2f", face.getIsRightEyeOpenProbability()),
                cx - ID_X_OFFSET * 2, cy + ID_Y_OFFSET, mIdPaint);
        canvas.drawText("left: " + String.format(Locale.ENGLISH, "%.2f", face.getIsLeftEyeOpenProbability()),
                cx + ID_X_OFFSET * 2, cy + ID_Y_OFFSET, mIdPaint);
